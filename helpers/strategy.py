...
class Strategy:
    ...
    def __init__(self, select = 'rand1bin', ppoints = None):
        strategy = {
    ...
    def best1bin(self,x, y, x1, CR,F, ppoints = None):
        ...
        for iy in range(x.dim):
            ...
            if ri < CR or iy == R:
                ...
                y.coords[iy] = self.points[iy].best() + F * (x1[a].coords[iy] - x1[b].coords[iy])
    ...
    def best2bin(self,x, y, x1 , CR,F, ppoints = None):
        ...
        for iy in range(x.dim):
            ...
            if ri < CR or iy == R:
                ...
                y.coords[iy] = self.points[iy].best() + F * (x1[a].coords[iy] + x1[b].coords[iy] - x1[c].coords[iy] - x1[d].coords[iy])
