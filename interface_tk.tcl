...
#  Mar 15, 2019 02:18:56 PM -03  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 936x689+175+81
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    place $top.can53 \
        ...
        -anchor nw -bordermode ignore 
    place $top.but54 \
        -in $top -x 360 -y 410 -width 45 -relwidth 0 -height 30 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but55 \
        -in $top -x 830 -y 410 -width 45 -height 30 -anchor nw \
        -bordermode ignore 
    place $top.but45 \
        -in $top -x 660 -y 630 -anchor nw -bordermode ignore 
    place $top.fra44 \
        -in $top -x 420 -y 410 -width 395 -relwidth 0 -height 35 -relheight 0 \
        -anchor nw -bordermode ignore 
