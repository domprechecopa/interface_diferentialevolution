...
#  Jan 24, 2019 10:17:31 AM -03  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 936x633+250+194
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    canvas $top.can53 \
        ...
        -selectforeground black -width 551 
    ...
    vTcl:DefineAlias "$top.but55" "prev_grafico_1" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra43 \
    ...
    place $top.lab45 \
        ...
        -anchor nw -bordermode ignore 
    place $top.scr46 \
        -in $top -x 50 -y 410 -width 848 -relwidth 0 -height 165 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but48 \
        -in $top -x 780 -y 580 -anchor nw -bordermode ignore 
    place $top.can53 \
        -in $top -x 340 -y 20 -width 551 -relwidth 0 -height 361 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but54 \
        -in $top -x 500 -y 380 -width 45 -relwidth 0 -height 30 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but55 \
        -in $top -x 680 -y 380 -width 45 -height 30 -anchor nw \
        -bordermode ignore 
